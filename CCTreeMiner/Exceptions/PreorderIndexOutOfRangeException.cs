...
{
    public class PreorderIndexOutOfRangeException : ApplicationException
    {
        private readonly string messageDetails = String.Empty;

        public string CauseOfError { get; set; }

        public PreorderIndexOutOfRangeException() { }

        public PreorderIndexOutOfRangeException(string message, string cause)
        {
        ...
        public override string Message
        {
            get
            {
                return string.Format("Preorder Index Out Of Range Error Message: {0}", messageDetails);
            }
        }
    }
}
